...
public class CalculadoraEstatistica implements ISequencia {
    ...
    //Classe com construtor privado, nao instancia nenhum objeto.
    ...
    public static CalculadoraEstatistica getInstance(){
        ...
        return instance;
        //se a instancia de referencia for nula, ainda nao foi criada a calculadora. UNICO OBJETO DA CLASSE É GARANTIDO AQUI.
    }
