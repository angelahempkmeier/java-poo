...
public class ArquivoPessoaDAO {
    private final String caminho = "src/arquivos/files/pessoas.csv";
    ...
    private List<String> listaPessoasToString(List<Pessoa> pessoas){
    ...
    public void salvaPessoasArquivo(List<Pessoa> pessoas){
        arquivo.gravaTexto(caminho, listaPessoasToString(pessoas));
    }
